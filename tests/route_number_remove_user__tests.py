...
class RouteNumberRemoveUserTests(NumberServiceInitializedTestCase):
    ...
    def test_route_remove_number_user__with_user_auth_token(self):
        user_id = "amy@apple.com"
    ...
    def test_route_remove_number_user__with_invalid_number(self):
        admin_auth_token = "abc123"
        number_id = "com.myapp"
        user_id = "amy@apple.com"
