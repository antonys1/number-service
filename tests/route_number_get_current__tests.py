...
class RouteNumberGetCurrentTests(NumberServiceInitializedTestCase):
    ...
    def test_route_number_get_current__with_invalid_auth_token(self):
        # Given
        user_id = "amy@apple.com"
        user_auth_token = "abc123"
        number_id = "com.myapp"
    ...
    def test_route_number_get_current__with_invalid_number(self):
        # Given
        user_id = "amy@apple.com"
        user_auth_token = "abc123"
        with postgres.get_db_conn() as conn:
